...
이 저장소가 더할 수 있는 것은 셋뿐이다.

- frontmatter의 `license`·`metadata`
- 상단 배너 또는 안내
- 문서 끝의 `출처` 절

본문·규칙·레퍼런스는 그대로 둔다. 오타도 고치지 않는다.

### 2. 고칠 것이 있으면 상류에서 고친다
...
### 4. `metadata.source`에 저장소·브랜치·경로를 적는다
